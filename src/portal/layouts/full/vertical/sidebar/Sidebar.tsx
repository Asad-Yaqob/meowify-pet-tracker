...
const SidebarLayout = ({ onClose }: { onClose?: () => void }) => {
  ...
  return (
    ...
    >
      {/* Logo Wrapper */}
      <div className="h-[71px] px-6 flex items-center justify-center brand-logo overflow-hidden bg-primary">
      ...
      {/* Sidebar items */}
      <SimpleBar className="h-[calc(100vh-100px)]" style={{ height: 'calc(100vh - 100px)' }}>
